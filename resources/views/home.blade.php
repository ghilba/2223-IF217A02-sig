                        ...
                        <div class="card swiper-slide">
                            <div class="kartu">
                                <div class="card-image">
                                    <img src="https://www.javatravel.net/wp-content/uploads/2022/05/Pondok-Pinus-Palutungan-Kuningan.jpg"
                                        alt="" class="card-img">
                                </div>
                                <div class="card-content">
                                    <h2 class="name">{{ $destination->title }}</h2>
                                    <p class="description">{{ $destination->description }}<img src="{{ asset('/img/beranda/locate.png') }}"
                                            alt="">{{ $destination->city }}</p>
                        ...
                        {{-- <div class="card swiper-slide">
                            <div class="kartu">
                                ...
                                <div class="card-content">
                                    ...
                                    <p class="description"><img src="{{ asset('/img/beranda/locate.png') }}"
                                            alt="">Yogyakarta</p>
